defmodule Exy.Gateway.Telegram.Update do
  @moduledoc """
  Converts Telegram update maps/structs into Exy gateway messages.
  ...
  known Bot API fields and emitting `%Exy.Gateway.Message{}` plus trigger
  ...
  @doc "Normalizes a Telegram update into an Exy gateway message."
