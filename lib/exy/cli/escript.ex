defmodule Exy.CLI.Escript do
  @moduledoc "Escript entrypoint for the standalone `exy` binary."
  ...
  def main(argv) do
    ...
    cond do
      ...
      opts[:version] -> Exy.CLI.main(argv)
      true -> run(argv, opts)
    end
  end
  ...
  defp cache_root(path) do
    ...
    Path.join([
      to_string(:filename.basedir(:user_cache, "exy")),
      "escripts",
      @version,
