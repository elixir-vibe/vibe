defmodule Exy.Web.SessionsLive do
  @moduledoc "LiveView landing page for Exy session history and active runtime status."
  use Exy.Web, :live_view

  alias Exy.Web.Sessions.Query
  ...
  def handle_event("delete_selected", _params, socket) do
    result =
      socket.assigns.selected_sessions |> MapSet.to_list() |> Exy.Session.Store.delete_many()
