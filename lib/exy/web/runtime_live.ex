defmodule Exy.Web.RuntimeLive do
  @moduledoc """
  LiveView runtime dashboard for Exy's BEAM process.
  """
  ...
  def render(assigns) do
    ~H"""
    <.app_shell current={:runtime} title="Runtime" subtitle="A LiveDashboard-style view focused on Exy's sessions, jobs, storage, plugins, and BEAM health.">
      <:sidebar>
        <.panel title="Node">
