defmodule Exy.Web.SkillsLive do
  @moduledoc "LiveView for installed Markdown and executable Exy skills."
  ...
  def render(%{skill: skill} = assigns) when is_map(skill) do
    ~H"""
    <.app_shell current={:skills} title={@skill.name} subtitle={@skill.title || "Installed Exy skill"}>
  ...
  def render(assigns) do
    ~H"""
    <.app_shell current={:skills} title="Skills" subtitle="Reusable workflow knowledge available to Exy agents.">
