defmodule Exy.Telemetry do
  ...
  @events [
    [:exy, :session, :command, :start],
    [:exy, :session, :command, :stop],
    [:exy, :session, :command, :exception],
    [:exy, :plugin, :load, :start],
    [:exy, :plugin, :load, :stop],
    [:exy, :plugin, :load, :exception],
