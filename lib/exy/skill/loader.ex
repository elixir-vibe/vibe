defmodule Exy.Skill.Loader do
  ...
  def discover(opts \\ []) do
    opts
    |> Keyword.get(:paths, Exy.Skill.script_paths())
  ...
  defp skill_module?(module) do
    Code.ensure_loaded?(module) and Exy.Skill.Script in behaviours(module)
  end
  ...
  defp executable(module, path) do
    ...
    %Executable{
      ...
      apis: Enum.map(module.apis(), &Exy.Plugin.API.new/1)
    }
  end
end
