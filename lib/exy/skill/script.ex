defmodule Exy.Skill.Script do
  @moduledoc """
  Behaviour and tiny DSL for executable Exy skills.
  ...
  defmacro __using__(_opts) do
    quote do
      @behaviour Exy.Skill.Script
      import Exy.Skill.Script, only: [skill: 1]
      Module.register_attribute(__MODULE__, :exy_skill, accumulate: false)
      @before_compile Exy.Skill.Script
    end
  end
  ...
  defmacro skill(do: block) do
    ...
    quote do
      @exy_skill unquote(Macro.escape(metadata))
    end
  end

  defmacro __before_compile__(env) do
    metadata = Module.get_attribute(env.module, :exy_skill) || %{}
