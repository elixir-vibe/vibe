defmodule Vibe.Auth do
  ...
  @builtin %{
    "openai-codex" => Vibe.Auth.Codex,
    "codex" => Vibe.Auth.Codex,
    "openrouter" => Vibe.Auth.OpenRouter,
    "open-router" => Vibe.Auth.OpenRouter,
    "opencode" => Vibe.Auth.OpenCode,
    "opencode-go" => Vibe.Auth.OpenCode
  }
  ...
  def providers do
    configured = Application.get_env(:vibe, :auth_providers, %{})
