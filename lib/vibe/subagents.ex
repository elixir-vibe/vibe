defmodule Vibe.Subagents do
  @moduledoc """
  Supervised subagent orchestration.

  Subagents are Vibe jobs, not detached prompts. LLM subagents create child Vibe
  ...
  Vibe's storage layer.
  """

  alias Vibe.Subagents.{Manager, Scheduler}
