defmodule Vibe.TUI.KeyDecoder do
  @moduledoc """
  ...
  def decode_event(%Ghostty.KeyEvent{key: :tab, mods: [:shift]}), do: [:cycle_effort]
  ...
  def decode_event(%Ghostty.KeyEvent{key: :p, mods: [:ctrl]}), do: [:cycle_model_forward]
  def decode_event(%Ghostty.KeyEvent{key: :l, mods: [:ctrl]}), do: [:open_model_selector]
