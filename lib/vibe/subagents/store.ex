defmodule Vibe.Subagents.Store do
  @moduledoc "JSONL-backed subagent schedule persistence."
  import Ecto.Query

  alias Vibe.Storage
  alias Vibe.Storage.Schema.SubagentSchedule
  alias Vibe.Subagents.Schedule
  ...
  def append_cancelled(id) do
    ...
    |> Vibe.Repo.update_all(set: [cancelled_at: now, updated_at: now])
