defmodule Vibe.CLI.Logging do
  @moduledoc "Session-scoped log file management for CLI runs."
  ...
  defp attach_session_log(session_id) do
    path = Vibe.Session.Store.log_path(session_id)
    File.mkdir_p!(Path.dirname(path))
    _ = :logger.remove_handler(:vibe_session_log)

    case :logger.add_handler(:vibe_session_log, :logger_std_h, %{
           level: :debug,
