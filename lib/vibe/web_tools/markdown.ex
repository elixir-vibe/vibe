defimpl Vibe.Markdown, for: Vibe.WebTools.SearchResult do
...
defimpl Vibe.Markdown, for: Vibe.WebTools.SearchItem do
...
defimpl Vibe.Markdown, for: Vibe.WebTools.FetchResult do
  ...
  defp body(%{format: :html, text: text}) do
    case Vibe.WebTools.HTML.to_markdown(text || "") do
