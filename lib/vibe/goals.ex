defmodule Vibe.Goals do
  ...
  def get(session_id \\ Vibe.Session.Current.session_id())
  def get(nil), do: nil
  ...
  def update_status(session_id \\ Vibe.Session.Current.session_id(), status)
  ...
  def clear(session_id \\ Vibe.Session.Current.session_id())
