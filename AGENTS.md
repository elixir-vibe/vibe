...
- Subagents are supervised jobs with child sessions. Use `Exy.Subagents.start/2`, `ask/2`, `run_many/2`, and `schedule/2`; attach to a running child session with `exy a <child_session_id>`.
