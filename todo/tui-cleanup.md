...
- Hide or relocate developer-only trace/testing artifacts so end users do not see root-level temporary files such as escripts, tarballs, crash dumps, trace directories, or disposable scenario outputs during normal Exy use.
