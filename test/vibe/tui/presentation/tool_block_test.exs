defmodule Vibe.TUI.Presentation.ToolBlockTest do
  ...
  test "renders text, inspect, source, diff, markdown, and lines blocks" do
    ...
    rendered = ToolBlock.display_body_lines(display, 80, Theme.default())
  ...
  test "returns nil for empty display bodies" do
    assert is_nil(ToolBlock.display_body_lines(%Display{body: []}, 80, Theme.default()))
  end
